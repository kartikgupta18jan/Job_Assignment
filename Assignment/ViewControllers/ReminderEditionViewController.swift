...
class ReminderEditionViewController: DataTableViewController, UITextFieldDelegate {
    ...
    func reloadDateRow(){
        let dateIndex = self.sections[0].sectionRows.firstIndex(of:Rows.DateRow)!
    ...
    @objc func dateSwitchValueChanged(dateSwitch: UISwitch){
        ...
        if (dateSwitch.isOn){
            ...
            let dateSwitchIndex = self.sections[FormSection].sectionRows.firstIndex(of:Rows.DateRow)!
            ...
            if let datePickerIndex = self.sections[FormSection].sectionRows.firstIndex(of:Rows.DatePickerRow) {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if (cellId == Rows.DateRow) {
            if let index = self.sections[indexPath.section].sectionRows.firstIndex(of:Rows.DatePickerRow){
