...
class AlarmListViewController: UIViewController, RingingAlarmLaunchable{
    ...
    func sendAlarmForEditing(_ alarm: AlarmEntity){
        ...
        modifyAlarmVC.delegateDone = self
        // Load the VC
...
extension AlarmListViewController: SetAlarmDone{
    func alarmDataPass(){
        self.refreshUI()
    }
}
